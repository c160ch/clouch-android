...
public class AWalletBottomNavigationView extends LinearLayout {
    ...
    private final ImageView clouch;
    ...
    private final TextView clouchLabel;
    ...
    public AWalletBottomNavigationView(Context context, @Nullable AttributeSet attrs) {
        ...
        clouch = findViewById(R.id.nav_clouch);
        ...
        clouchLabel = findViewById(R.id.nav_clouch_text);
        ...
        findViewById(R.id.clouch_tab).setOnClickListener(v -> selectItem(CLOUCH));
        ...
        clouch.setOnClickListener(v -> selectItem(CLOUCH));
        ...
        clouchLabel.setOnClickListener(v -> selectItem(CLOUCH));
    ...
    public void setSelectedItem(WalletPage index) {
        ...
        switch (index) {
            case CLOUCH:
                clouch.setImageResource(R.drawable.ic_star_active);
                clouchLabel.setTextColor(getResources().getColor(R.color.colorHighlight, getContext().getTheme()));
                break;
            case DAPP_BROWSER:
    ...
    private void deselectAll() {
        ...
        clouch.setImageResource(R.drawable.ic_star);
        ...
        clouchLabel.setTextColor(getContext().getColor(R.color.dove));
